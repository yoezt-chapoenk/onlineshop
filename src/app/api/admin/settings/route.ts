...
const Schema = z.object({
  ...
  rajaongkir_api_key: z.string().nullable().optional(),
  rajaongkir_payment_settings: z.string().nullable().optional(),
  default_origin_id: z.string().nullable().optional(),
  default_origin_pinpoint: z.string().nullable().optional(),
